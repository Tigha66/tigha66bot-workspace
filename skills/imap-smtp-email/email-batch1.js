...
const batch1 = [
  {to: "training@houseofhairuk.com", business: "House of Hair UK"},
  {to: "info@hairculturesalon.co.uk", business: "Hair Culture Salon"},
  {to: "salons@canonbury.co.uk", business: "Canonbury Hair"},
  {to: "info@hairbyaggela.co.uk", business: "Love Is In The Hair by Aggela"},
  {to: "info@ukcleaning.co.uk", business: "UK Cleaning"}
];
...
Unsubscribe: Reply with "STOP" to opt out`
  ...
  transporter.sendMail(mailOptions, (err, info) => {
    ...
    if (sent === batch1.length) {
      console.log(`\n🎉 Batch 1 Complete: ${sent}/5 emails sent`);
      process.exit(0);
    }
  });
});
